...
@asyncio.coroutine
def get_disk_format_asyncio(glance_connection: GlanceConnection, snapshot_name: str):
    """
    Get a list of disk format of snapshot_name from glance_connection region
...
@asyncio.coroutine
def get_container_format_asyncio(glance_connection: GlanceConnection, snapshot_name: str):
    """
    Get a list of container format of snapshot_name from glance_connection region
